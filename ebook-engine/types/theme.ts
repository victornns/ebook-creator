...
export interface EbookTheme {
  ...
  /**
   * Localization labels for UI text generated by the engine.
   * Override these to change the language or wording.
   */
  labels?: {
    /** Label shown before the chapter number on chapter covers and the TOC. Defaults to "Chapter". */
    chapter?: string;
    /** Title of the Table of Contents page. Defaults to "Contents". */
    toc?: string;
  };
}
